...
public class GlueSchemaExtractor {
   ...
   */
  public String toTypeString(OneSchema fieldSchema, String tableFormat) {
    switch (fieldSchema.getDataType()) {
      ...
      case BYTES:
        return "binary";
      case DECIMAL:
        Map<OneSchema.MetadataKey, Object> metadata = fieldSchema.getMetadata();
        ...
        int scale =
            (int)
                metadata.computeIfAbsent(
                    OneSchema.MetadataKey.DECIMAL_SCALE,
                    k -> {
  ...
  @VisibleForTesting
  static String getColumnProperty(String tableFormat, String property) {
