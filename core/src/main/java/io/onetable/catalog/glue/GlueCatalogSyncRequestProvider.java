...
abstract class GlueCatalogSyncRequestProvider {
  ...
  public GlueCatalogSyncRequestProvider(GlueCatalogConfig glueCatalogConfig) {
    this.glueCatalogConfig = glueCatalogConfig;
  }

  abstract TableInput getCreateTableInput(OneTable table, TableIdentifier tableIdentifier);
