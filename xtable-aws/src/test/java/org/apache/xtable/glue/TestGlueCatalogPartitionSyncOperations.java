...
public class TestGlueCatalogPartitionSyncOperations extends GlueCatalogSyncTestBase {
  ...
  void testGetAllPartitionsSuccess() {
    ...
    List<org.apache.xtable.catalog.Partition> partitions =
        mockGluePartitionSyncOperations.getAllPartitions(TEST_CATALOG_TABLE_IDENTIFIER);
  ...
  void testAddPartitionsToTableSuccess() {
    ...
    mockGluePartitionSyncOperations.addPartitionsToTable(
        ...
        Collections.singletonList(
            new org.apache.xtable.catalog.Partition(
  ...
  void testUpdatePartitionsToTableSuccess() {
    ...
    org.apache.xtable.catalog.Partition partitionToUpdate =
        new org.apache.xtable.catalog.Partition(
  ...
  void testDropPartitionsSuccess() {
    ...
    org.apache.xtable.catalog.Partition partitionToDrop =
        new org.apache.xtable.catalog.Partition(Collections.singletonList("value1"), "location1");
  ...
  void testGetLastTimeSyncedPropertiesSuccess() {
    ...
    Map<String, String> result =
        mockGluePartitionSyncOperations.getTableProperties(
  ...
  void testUpdateLastTimeSyncedPropertiesSuccess() {
    ...
    // Execute the method
    mockGluePartitionSyncOperations.updateTableProperties(
